 ...
 */
class MangaDetailFragment : Fragment(), ChapterAdapter.ChapterClickListener {
    ...
    companion object {
        ...
        fun newInstance(libraryItem: LibraryItem): MangaDetailFragment {
    ...
    override fun onChapterClick(chapter: Chapter, pos: Int) {
        viewModel.getChapterProvider(pos, adapter.getData()).observe(this, Observer { provider ->
            ChapterLoader.useProvider(provider)
