 ...
 */
public class Settings extends BaseActivity implements Preference.OnPreferenceChangeListener{
    ...
    public static class SettingsFragment extends PreferenceFragment{
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            findPreference(getString(R.string.pref_themes_key)).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(Preference preference, Object o) {
                    MaterialListPreference listPreference = (MaterialListPreference) preference;
                    int index = listPreference.findIndexOfValue(o.toString());
                    ((MaterialListPreference) preference).setValueIndex(index);
                    ((Settings) getActivity()).themeChanged(true);
                    return true;
                }
            });
                            ...
                            .itemsCallbackMultiChoice(new Integer[]{}, new MaterialDialog.ListCallbackMultiChoice() {
                                ...
                                public boolean onSelection(MaterialDialog materialDialog, Integer[] integers, CharSequence[] charSequences) {
                                    ...
                                    if (integers.length == 1) {
                                        intent.putExtra(DownloadMangaDatabase.FIX_SELECTION, integers[0]);
